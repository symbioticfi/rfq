...
3. For every leg, a current adapter owner, market maker, or authorized filler signs the Router-specific authorization described below.
...
- `Router` uses ordinary ERC-20 allowance plus a current adapter-authorized EIP-712 signature for every leg.
