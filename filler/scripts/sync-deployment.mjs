...
const deploymentEnv = normalizeDeploymentEnv(
  process.env.RFQ_FILLER_DEPLOYMENT_ENV || fileEnv.RFQ_FILLER_DEPLOYMENT_ENV || "local",
);
...
console.log(`Synced filler deployment ${deploymentEnv} -> rfq/filler/src/generated/deployment.ts`);
